...
public class EjecucionLocalDateTime {
    public static void main(String[] args) {
       ...
       fechaTiempo = LocalDateTime.parse("2020-12-24T21:45:59");
        System.out.println("fechaTiempo = " + fechaTiempo);

        LocalDateTime fechaTiempo2 = fechaTiempo.plusDays(1).plusHours(3);

        System.out.println("fechaTiempo 2: = "+ fechaTiempo2);
        System.out.println("fechaTiempo: = "+ fechaTiempo);
        System.out.println("fechaTiempo 3: = "+ fechaTiempo.minusHours(5));
